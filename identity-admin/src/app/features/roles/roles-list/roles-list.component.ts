...
import type { ApiResponse, PagedResult, RoleDto, PagedRequest } from '../../../shared/models/api.model';
...
export class RolesListComponent implements OnInit {
  ...
  load(): void {
    ...
    this.api.getRoles(this.request()).subscribe({
  ...
  deleteRole(id: string, name: string): void {
    ...
    const message = this.translate.instant('dialog.confirmDeleteRole', { name });
