...
public class IndividualKycService : IIndividualKycService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var entity = new IndividualKyc
        {
            ...
            ApplicantResidenceStatusId = dto.ApplicantResidenceStatusId,
            ApplicantEmirateId = dto.ApplicantEmirateId,
            ApplicantPlaceOfBirthCountryId = dto.ApplicantPlaceOfBirthCountryId,
    ...
    private static IndividualKycDto MapToDto(IndividualKyc k) => new()
    {
        ...
        ApplicantResidenceStatusId = k.ApplicantResidenceStatusId,
        ApplicantEmirateId = k.ApplicantEmirateId,
        ApplicantPlaceOfBirthCountryId = k.ApplicantPlaceOfBirthCountryId,
