...
public class IndividualBulkUploadBatch : IEntity, IAuditable, ISoftDelete, ITenantEntity
{
    ...
    public ICollection<IndividualBulkUploadLine> Lines { get; set; } = new List<IndividualBulkUploadLine>();
}
